...
enum  pattern { NONE, RAINBOW_CYCLE, THEATER_CHASE, COLOR_WIPE, SCANNER, FADE, SINE_WAVE };
...
class NeoPatterns : public Adafruit_NeoPixel
{
  public:
    ...
    void SineWave(uint32_t color1, uint8_t interval, direction dir = FORWARD)
    {
...
NeoPatterns Ring1(7, 6, NEO_GRB + NEO_KHZ800, &Ring1Complete);
